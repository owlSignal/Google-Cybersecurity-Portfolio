...
# Reading/writing files are another strong tool in developing algorithms that will help in automating security tasks.

# Loops and conditionals are needed to iterate through files and their content.

# Python gives you lots of out of the box tools to get complex tasks done.
